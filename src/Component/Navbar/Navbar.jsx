              ...
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0 align-items-cente gap-2">
                <ul className="social-list list-unstyled d-flex align-items-center gap-3">
                  <li>
                    <a
                      target="_blank"
                      href="https://www.facebook.com/zyad.walid.zezo"
                    >
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.instagram.com/realzyaadwalid18/"
                    >
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.linkedin.com/in/zyad-walid-36b47127b/"
                    >
                      <i className="fa-brands fa-linkedin"></i>
                    </a>
                  </li>
                  <li>
                    <a target="_blank" href="https://twitter.com/ZyadWalid404">
                      <i className="fa-brands fa-x-twitter"></i>
                    </a>
                  </li>
                  <li>
                    <a target="_blank" href="https://zyadwallo.77@gmail.com">
                      <i className="fa-solid fa-envelope"></i>
                    </a>
                  </li>

                  <li>
                    <a target="_blank" href="https://github.com/Zyadwalid1">
